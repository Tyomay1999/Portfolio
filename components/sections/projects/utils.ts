...
export const projects: Project[] = [
  {
    ...
    desc: {
      ...
      hy: 'GenieWeb-ի հանրային էջն ու մուտք գործելու համակարգը, որտեղ օգտատերերը կարող են ծանոթանալ ծրագրավորման դասընթացներին, ծառայություններին և հեշտությամբ գրանցվել։',
    },
  ...
  },
  {
    ...
    desc: {
      en: 'Internal web platform for GenieWeb instructors. Enables teachers to manage student groups, schedule lessons, assign homework and exams, and monitor academic progress.',
      ru: 'Внутренняя веб-платформа для преподавателей GenieWeb. Позволяет управлять группами, расписанием, домашними заданиями и экзаменами, а также отслеживать успеваемость студентов.',
      hy: 'GenieWeb-ի ուսուցիչների ներբանկային հարթակը՝ խմբերի վարում, դասացուցակ, առաջադրանքների ու քննությունների նշանակում, ինչպես նաև առաջադիմության վերահսկում։',
    },
  ...
  },
  {
    ...
    desc: {
      ...
      hy: 'Ուսանողների համար նախատեսված հարթակ՝ ապահով մուտքով դեպի դասեր, առաջադրանքների հանձնում, քննությունների ժամանակացույց և առաջադիմության հետևում։',
    },
