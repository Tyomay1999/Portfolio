        ...
        <StorySectionWrapper sectionId={6} innerClassName="max-w-4xl mx-auto px-4">
            ...
            <div className="text-center mb-12 md:mb-16">
                <p className="text-lg md:text-xl text-slate-700 dark:text-slate-300 font-sans leading-relaxed max-w-3xl mx-auto">
                    ...
                    Every line of code should serve a purpose, every design decision should enhance the user's journey,
            ...
            <div className="space-y-8 md:space-y-12">
                {faqs.map((faq, idx) => (
                    <div
                        key={idx}
                        className={idx < faqs.length - 1 ? 'border-b border-slate-200 dark:border-slate-700 pb-6 md:pb-8' : 'pb-6 md:pb-8'}
                    >
