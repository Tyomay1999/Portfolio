...
export default function AboutMe() {
  ...
  return (
    <StorySectionWrapper sectionId={0}>
      <div className="text-my-light-text dark:text-my-dark-text mx-auto max-w-3xl px-4 text-center transition-colors duration-300">
        ...
        <div className="space-y-6 font-sans text-base leading-relaxed text-slate-700 dark:text-slate-300 md:space-y-8 md:text-lg lg:text-xl">
          ...
          <ul className="mb-6 ml-10 list-disc space-y-2 pl-6 text-justify">
