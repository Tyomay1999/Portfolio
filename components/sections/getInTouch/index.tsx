...
export default function CallToActionSection(): JSX.Element {
  ...
  return (
    <StorySectionWrapper sectionId={7} innerClassName="max-w-3xl mx-auto text-center px-4">
      ...
      <button
        onClick={handleClick}
        className="transform rounded-lg bg-slate-900 px-8 mb-8 py-4 font-sans text-lg text-white shadow-lg transition-all duration-300 hover:scale-105 hover:bg-slate-800 hover:shadow-xl dark:bg-slate-100 dark:text-slate-900 dark:hover:bg-slate-200 md:px-12 md:py-5 md:text-xl"
      >
        {t('button')}
      </button>
